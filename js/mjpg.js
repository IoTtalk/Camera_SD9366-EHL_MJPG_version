let ADDR_IP_CAM = "IP";  //camera IP
let PORT_IP_CAM_API = "PORT";  //camera HTTP port 
let VIDEO_FILE_NAME = "mjpg_file_name"; //MJPG file name

let ADDR_REMOTE_CONTROL = "your iframe html page"; //Remote control or Dashboard webpage
